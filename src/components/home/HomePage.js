  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        ...
        const topBooksArray = [booksArray[0], booksArray[1], booksArray[2], booksArray[3], booksArray[4], booksArray[5]];
        const soonBooksArray = [booksArray[6], booksArray[7], booksArray[8], booksArray[9], booksArray[11], booksArray[12]];
